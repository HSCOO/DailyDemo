...
static Byte iv[] = {'a', 'b', 'c', 'd', 'e', 'g', '@', '*' };
static const char encodingTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";


@implementation DESCEBTools
...
// 解密的时候不要要先转成base64二进制。然后再解密
+ (NSString *)decrypt:(NSString *)base64Str key:(NSString *)key{
    // base64 str -> base64 data
    NSData *base64Data = [self dataWithBase64EncodedString:base64Str];
    
    // decrypt base64 data
    NSData *decyptData = [self DESDecrypt:base64Data WithKey:key];
    
    // to string
    NSString *finalStr = [[NSString alloc] initWithData:decyptData encoding:NSUTF8StringEncoding];
